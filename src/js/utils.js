...
/**
 * Attaches an event listener to a collectioni of DOM elements.
 *
 ...
 * @param {Function} callback - The function to be executes when the event occurs.
 */
 ...
 *
 * @param {HTMLElement} $element - The DOM element to mkae editable.
 */
 ...
 * @param {Object} notebookId - The ID of the notebook to find.
 * @returns {Object | undefined} The found notebook object, or udefined if not found.
 */
